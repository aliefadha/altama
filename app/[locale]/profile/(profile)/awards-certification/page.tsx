        ...
        <div className="max-w-[1440px] mx-auto px-5 lg:px-[80px]">
          <div className="relative">
            ...
            <div className="flex gap-3 lg:gap-6 items-center justify-center">
              {/* Back Button */}
              <Link href={`/${locale}/profile/company-overview`} className="flex gap-2 items-center justify-center px-5 lg:px-6 py-2.5 lg:py-2.5 rounded-full border-2 border-[#353185] bg-transparent hover:bg-[#353185] transition-all duration-300 group">
              ...
              {/* Next Button */}
              <Link href={`/${locale}/profile/board-of-directors`} className="bg-[#353185] flex gap-2 items-center justify-center px-5 lg:px-6 py-2.5 lg:py-2.5 rounded-full hover:bg-[#605bc3] transition-colors">
