                    ...
                    <div className="flex gap-[16px] md:gap-[20px] lg:gap-[40px] overflow-x-auto pb-[20px] snap-x snap-mandatory" style={{ scrollbarWidth: 'none', WebkitScrollbar: 'none' } as React.CSSProperties} ref={scrollContainerRef}>
                        ...
                        <div className="bg-[#f8f7f7] flex flex-col gap-[20px] md:gap-[24px] px-[20px] md:px-[24px] py-[20px] md:py-[24px] rounded-[20px] min-w-[calc(100vw-32px)] md:min-w-[300px] lg:min-w-[460px] snap-start">
                            <div className="flex flex-col gap-[16px]">
                                ...
                                {/* Author */}
                                <div className="flex gap-[12px] items-center">
                                    <Image alt={`Photo of ${t('testimonials.items.5.name')}, ${t('testimonials.items.5.position')}`} className="rounded-full size-[44px]" src={imgEllipse13} width={44} height={44} />
                                    <div className="flex flex-col gap-[2px]">
                                        <p className="font-inter text-[18px] text-[#121212] tracking-[-0.72px]">{t('testimonials.items.5.name')}</p>
                                        <p className="font-inter text-[13px] text-[#353185] tracking-[-0.52px]">{t('testimonials.items.5.position')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#f8f7f7] flex flex-col gap-[20px] md:gap-[24px] px-[20px] md:px-[24px] py-[20px] md:py-[24px] rounded-[20px] min-w-[calc(100vw-32px)] md:min-w-[300px] lg:min-w-[460px] snap-start">
                            <div className="flex flex-col gap-[16px]">
                                ...
                                {/* Author */}
                                <div className="flex gap-[12px] items-center">
                                    <Image alt={`Photo of ${t('testimonials.items.6.name')}, ${t('testimonials.items.6.position')}`} className="rounded-full size-[44px]" src={imgEllipse14} width={44} height={44} />
                                    <div className="flex flex-col gap-[2px]">
                                        <p className="font-inter text-[18px] text-[#121212] tracking-[-0.72px]">{t('testimonials.items.6.name')}</p>
                                        <p className="font-inter text-[13px] text-[#353185] tracking-[-0.52px]">{t('testimonials.items.6.position')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#f8f7f7] flex flex-col gap-[20px] md:gap-[24px] px-[20px] md:px-[24px] py-[20px] md:py-[24px] rounded-[20px] min-w-[calc(100vw-32px)] md:min-w-[300px] lg:min-w-[460px] snap-start">
                            <div className="flex flex-col gap-[16px]">
                                ...
                                {/* Author */}
                                <div className="flex gap-[12px] items-center">
                                    <Image alt={`Photo of ${t('testimonials.items.7.name')}, ${t('testimonials.items.7.position')}`} className="rounded-full size-[44px]" src={imgEllipse10} width={44} height={44} />
                                    <div className="flex flex-col gap-[2px]">
                                        <p className="font-inter text-[18px] text-[#121212] tracking-[-0.72px]">{t('testimonials.items.7.name')}</p>
                                        <p className="font-inter text-[13px] text-[#353185] tracking-[-0.52px]">{t('testimonials.items.7.position')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#f8f7f7] flex flex-col gap-[20px] md:gap-[24px] px-[20px] md:px-[24px] py-[20px] md:py-[24px] rounded-[20px] min-w-[calc(100vw-32px)] md:min-w-[300px] lg:min-w-[460px] snap-start">
                            <div className="flex flex-col gap-[16px]">
                                ...
                                {/* Author */}
                                <div className="flex gap-[12px] items-center">
                                    <Image alt={`Photo of ${t('testimonials.items.8.name')}, ${t('testimonials.items.8.position')}`} className="rounded-full size-[44px]" src={imgEllipse12} width={44} height={44} />
                                    <div className="flex flex-col gap-[2px]">
                                        <p className="font-inter text-[18px] text-[#121212] tracking-[-0.72px]">{t('testimonials.items.8.name')}</p>
                                        <p className="font-inter text-[13px] text-[#353185] tracking-[-0.52px]">{t('testimonials.items.8.position')}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
