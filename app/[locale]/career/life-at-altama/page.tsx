      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 max-w-360 mx-auto px-5 lg:px-[80px] h-full flex flex-col gap-10 justify-center">
          ...
          <button
            ...
            className="relative bg-white flex gap-[8px] items-center justify-center px-[24px] py-[12px] rounded-[72px] w-fit cursor-pointer hover:bg-gray-100 transition-colors">
