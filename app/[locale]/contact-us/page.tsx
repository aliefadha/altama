            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[80px] items-start">
              ...
              <div className="flex flex-col gap-8 lg:gap-[40px]">
                ...
                <div className="hidden lg:block relative mt-[60px]">
                  {/* Alva Character */}
                  <div
                    className="absolute left-[180px] bottom-0 w-[240px] h-[240px] z-10 cursor-pointer hover:scale-105 transition-transform duration-300"
                ...
                {isOpen && (
                  <>
                    ...
                    {/* Chat Widget */}
                    <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[50] w-[calc(100vw-32px)] max-w-[367px] md:w-[367px] bg-white rounded-2xl shadow-2xl overflow-hidden">
                      {/* Header Purple */}
          ...
          <div className="max-w-[1440px] mx-auto px-5 lg:px-[80px] relative">
            ...
            <div className="relative max-w-full lg:max-w-[721px] mx-auto flex flex-col gap-8 lg:gap-[56px] items-center">
              ...
              <div className="relative">
                <button
                  onClick={() => router.push(`/${locale}/media-center`)}
                  className="bg-[#353185] text-white rounded-full px-6 lg:px-6 py-3 lg:py-3 text-[15px] lg:text-[18px]  font-semibold tracking-tight lg:tracking-[-0.96px] hover:bg-[#2a2667] transition-colors">
                  {t('insights.button')}
                </button>
